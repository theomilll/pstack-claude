...
- [ ] On her go, write this exact text as the standing objective at the top of this file (Claude Code has no `/goal`). "<The plan path, the PR ids in order, the verification rule, who merges, and the done condition.>"
...
- [ ] Arm the 30-minute audit tick. A real terminal `/loop`. Never leave the cadence to memory.
