...
- Substantive existing-skill edit (a new section, a new pattern table, more than ~10 lines): hand to the poteto-mode Authoring a skill playbook and run its draft / test / iterate loop.
...
- `new skill via the Authoring a skill playbook: <kebab-name>`: create it per the Authoring a skill playbook. Do not invent the shape ad hoc.
